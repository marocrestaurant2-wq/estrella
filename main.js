...
if (form) {
  ...
  form.addEventListener('submit', (e) => {
    ...
    const to = 'contact@estrella.ma'; // Update to official email when available
    const subject = encodeURIComponent('Website Contact - ESTRELLA HOLDING');
